    ...
    <div className="max-w-3xl mx-auto">
      <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
        <div className="col-span-2">
          ...
          />
          <h1 className="font-bold text-2xl my-4">{blog?.data?.data?.blogTitle}</h1>
          <div className="text-gray-800" dangerouslySetInnerHTML={{ __html: blog?.data?.data?.blogContent }} />
        </div>
        {/* <NavLink exact to= "/" */}
        <div className="bg-white rounded-xl p-5">
          ...
          <div className="flex flex-col items-center">
            ...
            <h1 className="font-bold text-xl text-gray-900 my-3">{blog?.data?.data?.authorName}</h1>
            </NavLink>
